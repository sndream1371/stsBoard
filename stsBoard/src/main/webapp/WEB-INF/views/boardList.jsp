...
<html>
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                $("a[name='subject']").click(function(){
                    ...
                    location.href = "${path}/board/view?id="+$(this).attr("content_id");
                     
                });
                 
                $("#write").click(function(){
                    location.href = "${path}/board/edit";
                });
    ...
    <body>
        <form class="form-inline" id="frmSearch" action="${path}/board/list">
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <c:forEach var="boardList" items="${boardList}" varStatus="status">
                                <tr>
                                    <td align="center">${(totalCnt - ((startPage-1)*10)) - status.index} </td>
                                    <td>
